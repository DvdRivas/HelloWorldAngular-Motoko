...
export { idlFactory } from './HelloWorld-MA-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HELLOWORLD_MA_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./HelloWorld-MA-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the HelloWorld-MA-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./HelloWorld-MA-backend.did.js")._SERVICE>}
 */
