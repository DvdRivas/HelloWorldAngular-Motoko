...
export const canisterId = process.env.CANISTER_ID_HELLOWORLD_MA_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./HelloWorld-MA-frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the HelloWorld-MA-frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./HelloWorld-MA-frontend.did.js")._SERVICE>}
 */
export const HelloWorld_MA_frontend = createActor(canisterId);
